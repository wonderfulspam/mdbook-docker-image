...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("awk",function(){"use strict";return function(e){return{
name:"Awk",keywords:{
...
}]}}}());hljs.registerLanguage("abnf",function(){"use strict";return function(s){return{
...
begin:/%[si]/},s.QUOTE_STRING_MODE,s.NUMBER_MODE]}}}());hljs.registerLanguage("powershell",function(){"use strict";return function(e){
var n={$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}}());hljs.registerLanguage("profile",function(){"use strict";return function(e){
...
end:"\\)$",excludeBegin:!0,excludeEnd:!0,relevance:0}]}}}());hljs.registerLanguage("javascript",function(){"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],s=[].concat(["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],["arguments","this","super","console","window","document","localStorage","module","global"],["Intl","DataView","Number","Math","Date","String","RegExp","Object","Function","Boolean","Error","Symbol","Set","Map","WeakSet","WeakMap","Proxy","Reflect","JSON","Promise","Float64Array","Int16Array","Int32Array","Int8Array","Uint16Array","Uint32Array","Float32Array","Array","Uint8Array","Uint8ClampedArray","ArrayBuffer"],["EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"])
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}}());hljs.registerLanguage("accesslog",function(){"use strict";return function(e){
var n=["GET","POST","HEAD","PUT","DELETE","CONNECT","OPTIONS","PATCH","TRACE"]
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}}());hljs.registerLanguage("haskell",function(){"use strict";return function(e){
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}}());hljs.registerLanguage("diff",function(){"use strict";return function(e){return{
...
begin:t,end:a,contains:[n],relevance:5}])}}}());hljs.registerLanguage("nix",function(){"use strict";return function(e){var n={
...
aliases:["nixos"],keywords:n,contains:s}}}());hljs.registerLanguage("yaml",function(){"use strict";return function(e){
...
begin:/\b(print|exec)\(/}]}}}());hljs.registerLanguage("vim",function(){"use strict";return function(e){return{
...
className:"symbol",begin:/<[\w-]+>/}]}}}());hljs.registerLanguage("lisp",function(){"use strict";return function(e){
...
contains:[b,e.SHEBANG(),s,g,l,o,u,m,c]}}}());hljs.registerLanguage("excel",function(){"use strict";return function(E){return{
...
excludeEnd:!0,illegal:/\n/})]}}}());hljs.registerLanguage("django",function(){"use strict";return function(e){
...
className:"template-variable",begin:/\{\{/,end:/}}/,contains:[t]}]}}}());hljs.registerLanguage("php",function(){"use strict";return function(e){var r={
...
illegal:"[^\\s\\}]"}}}());hljs.registerLanguage("bnf",function(){"use strict";return function(n){return{
...
}],illegal:/\S/}}}());hljs.registerLanguage("pgsql",function(){"use strict";return function(E){
...
contains:a}}}());hljs.registerLanguage("ebnf",function(){"use strict";return function(a){
var e=a.COMMENT(/\(\*/,/\*\)/);return{name:"Extended Backus-Naur Form",
illegal:/\S/,contains:[e,{className:"attribute",
begin:/^[ ]*[a-zA-Z][a-zA-Z-_]*([\s-_]+[a-zA-Z][a-zA-Z]*)*/},{begin:/=/,
end:/[.;]/,contains:[e,{className:"meta",begin:/\?.*\?/},{className:"string",
variants:[a.APOS_STRING_MODE,a.QUOTE_STRING_MODE,{begin:"`",end:"`"}]}]}]}}}());hljs.registerLanguage("cpp",function(){"use strict";return function(e){
